...
The system can support **pedestrian counting, traffic flow analysis, and adaptive traffic-light logic**, illustrating applications in **smart-city infrastructure**.
...
<img width="1000" height="550" padding-bottom="100" alt="image" src="https://github.com/user-attachments/assets/e8aa80f7-f929-4e72-bc2d-c616a8264d66" />



<img width="1000" height="550" alt="image" src="https://github.com/user-attachments/assets/b1885974-ab6f-4c6a-ac8f-6246bb3030dc" />

---

## Project Objectives

- **Real-Time Detection**  Detect pedestrians and vehicles from video using state-of-the-art object detection models (YOLOv8).

- **Multi-Object Tracking (MOT)**  Assign consistent IDs to moving objects across frames using Deep SORT or BoT-SORT, even under occlusion and crowding.

- **Analytics Layer**  Pedestrian counts per time interval, vehicle vs. pedestrian flow ratios and density heatmaps of crowded regions  

- **Application Demonstration**  Provide a software pipeline that allows users to upload traffic videos and trained detection models to generate analytics and traffic-control suggestions.
...
- Models used: `yolov8s.pt` (baseline) and `yolov8n.pt` (lightweight fine-tuned model)
...
- **Deep SORT**   Uses Kalman filtering + appearance embeddings for ID consistency  

- **BoT-SORT**   Improves association accuracy in dense and crowded scenes  
